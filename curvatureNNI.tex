...
Such time-trees have become a central object of study in phylogenetics.
...
Furthermore, we design an efficient heuristic for constructing these graphs.
...
We discuss the directions that are most valuable for phylogenetic applications and give a list of open problems of prominent importance for those applications.
\end{abstract}
