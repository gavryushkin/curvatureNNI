...
In this paper we study curvature of Markov chains over phylogenetic trees. 
...
and long. 
We shall address to the numbers assigned to the intercoalescent intervals as to the {\em lengths} of those intervals. 
...
Thus, we can interchangeable refer to $\dts$ as a graph or a metric space. 
...
As we will see in the next few lemmas, these boundaries can be improved for certain random walks on the graphs under consideration. 
