...
(2(n - 2) - 8) \cdot \frac{1}{2(n-2)} = 1 + \displaystyle\frac{4}{n-2}.
\]
Hence, $1 - W(m_T,m_R) \geq - \displaystyle\frac{4}{n-2}$. 
...
\]
$1 + \displaystyle\frac{4p}{n-2}$. Hence, 
$1 - W(m_T,m_R) \geq - \displaystyle\frac{4p}{n-2}$. The lemma follows. 
\endproof
