...
The upper bound is attained by a caterpillar tree with all intervals short, no divergence event being younger than a taxon, and both taxa of the cherry being younger than at leas one other taxon, that is, a caterpillar tree with internal nodes having ranks $n, \ldots, 2(n-1)$ and the ranks of the taxa in cherry $< n-1$.
