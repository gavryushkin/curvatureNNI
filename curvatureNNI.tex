...
The graph built on such trees provides a discretization of the space of time-trees, which we call a \emph{discretized time-tree graph}.
...
Up to now, the only discretization of time-tree space that has been studied is that of ranked trees \autocite{Page1991-rd,Ford2009-qi,Lambert2013-mr}, and that was not from a graph-theoretic perspective.
