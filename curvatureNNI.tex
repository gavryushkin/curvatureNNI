...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\todo[inline]{At first I thought that time-trees had all of their leaves sampled at the present, but later notes made me think otherwise. Please clarify.}
...
\todo{I find it confusing that before length could be 0, 1, or 2, but now it's just 1 and 2. I assume 0 = no coalescent interval, but...}
...
In this case, even intervals \todo{A little more detail, please? The nodes are numbered so far, not the intervals} add nothing to the degree of the tree and odd intervals add one each, hence $n-1$ in total.
...
\todo[inline]{What if the two trees just differ in terms of branch length?}
\endproof
...
\todo{Could you clarify? We should be talking about where the mass is in the coupling.}
