...
The upper bound is attained by a caterpillar tree with all intervals short and no divergence event being younger than a taxon, that is, a caterpillar tree with internal nodes having ranks $n+1, \ldots, 2(n-1)$.
