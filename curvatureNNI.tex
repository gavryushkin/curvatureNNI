...
It is not hard to see that the number of trees is
\todo{This should depend on $m$.}
$(n-1)! \cdot n! \cdot n!$ in $\dtt$, $(n-1)! \cdot n!$ in $\dttu$, $\frac{(n-1)!n!n!}{2^{n-1}}$ in $\rnni$, $\frac{(n-1)!n!}{2^{n-1}}$ in $\rnniu$, and $(2n - 3)!!$ in $\nni$.
