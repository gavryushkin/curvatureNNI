...
\item Hence, for this proof to work the diameter of the space on $n$ taxa must be bounded by $n^2$, and we only have $3n^2$---see Lemma~\ref{diameterUpperBound}.
\end{enumerate}
\endproof
...
This bound can be improved by going to a double caterpillar instead of caterpillar if the trees are sufficiently balanced!
