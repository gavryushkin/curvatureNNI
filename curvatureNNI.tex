...
The $\dtt_1$ graph is denoted by $\rnni$ and called \emph{ranked NNI} graph; on ultrametric trees we will denote it $\rnniu$.
...
Assuming that the solution is polynomial, we see that the polynomial must be of degree two.
...
However, these are the subject of a future work.
}
