...
In the previous section we posed Problem~\ref{complexityProblem}, which asks about the complexity of computing the distance in discrete time-tree graphs.
...
Hence, a natural question that would contribute to understanding Problem~\ref{complexityProblem} is whether or not the Split Theorem holds in the $\rnniu$ graph and other time-tree graphs.
...
\begin{enumerate}[(i)]
% We know the split theorem doesn't hold for $\nni$ 
%\item $2d(x,y)$ in $\nni$,
\item $3d(x,y)$ in $\rnni$,
