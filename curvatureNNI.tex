...
\todo[inline]{Should we add ultrametric trees?
The degree bounds will be different for them.}
...
A tree is hence given by a sequence of sets of taxa~\cite{Gavryushkin2014-bw}. For example, the representation of the tree on Figure~\ref{T5.pdf} is $(\{A\}, \{C\}, \{D\}, \{B\}, \{E\}, \{A,B\}, \{D,E\}, \{C, D, E\}, \{F\}, \{A,B,F\}, \{A,B,C,D,E,F\})$, or
