...
We continue with the following bounds on the sizes of one-neighbourhoods of various discretisations of the space of time trees, which are one of the most important tools for estimating the curvature of various random walks later in the paper.
