...
Furthermore, if we want to indicate that a node $v$ should never be destroyed, we label the node with an $a$ (\textcite{Sleator1992-bp} call this ``eliminating the zero label'').
