...
%EM Certainly there are many other prior authors that have called things NNI graph etc.
This graph-theoretic terminology is convenient and has become widespread in recent years \autocite{Whidden2015-yi}.
...
%EM "corresponding too" is maddeningly vague. Perhaps you mean "modifying"?
...
%EM Alex, do you prefer this "cube" terminology? In our phyloHMC paper, we call them "orthants".
...
%EM Should the end of this mega-sentence read "in the cherry"?
