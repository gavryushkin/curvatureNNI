...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\todo[inline]{At first I thought that time-trees had all of their leaves sampled at the present, but later notes made me think otherwise. Please clarify.} AG: fixed. 
...
%\todo{I find it confusing that before length could be 0, 1, or 2, but now it's just 1 and 2. I assume 0 = no coalescent interval, but...} AG: fixed. 
...
%\todo{A little more detail, please? The nodes are numbered so far, not the intervals} AG: fixed
