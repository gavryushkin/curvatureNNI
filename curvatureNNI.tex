...
Indeed, this can be achieved by considering an appropriate subpath between appropriate subtrees of $T$ and $R$.
...
\]
This is however a contradiction because under our assumption about ranks of nodes in $T$ and $R$, we have that $d(T,R) \le d(T_A, R_A) + d(T_B, R_B)$ by converting $T_A$ to $R_A$ and then independently $T_B$ to $R_B$.

The case when the assumption on ranks of $T$ and $R$ does not hold, follows similarly.
\endproof
